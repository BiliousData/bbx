	...
	//Fallthrough
				...
				if (pad_state.press & (PAD_START | PAD_CROSS))
				{
					switch (menu.select)
					{
						case 0: //Story Mode
							...
							break;
						case 1: //Freeplay
							menu.next_page = MenuPage_Chungus;
							break;
						case 2: //Mods
		...
		case MenuPage_Chungus:
		{
			...
			if (menu.next_page == menu.page && Trans_Idle())
			{
				...
				if (pad_state.press & (PAD_START | PAD_CROSS))
				{
					switch (menu.select) //guuh what the fuck
					{
						case 0: //B&B
							menu.next_page = MenuPage_Freeplay;
							break;
						case 1: //Freeplay
							menu.next_page = MenuPage_BackGround;
							break;
						case 2: //Mods
							menu.next_page = MenuPage_Takeover;
							break;
						case 3: //Options
							menu.next_page = MenuPage_Extra;
							break;
					}
					menu.next_select = 0;
					menu.trans_time = FIXED_UNIT;
		...
		case MenuPage_Takeover:
		{
			static const struct
			{
				...
				//{StageId_4_4, 0xFFFC96D7, "TEST"},
				{StageId_1_4, 0xFF9271FD, "COPYCAT"},
				{StageId_1_1, 0xFF9271FD, "JUMP OUT"},
				{StageId_1_2, 0xFF9271FD, "RONALD MCDONALD SLIDE"},
			};
